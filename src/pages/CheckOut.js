      ...
      <form className="needs-validation" novalidate="">
        ...
        <div class="my-3">
          ...
          <div class="form-check">
            ...
            <label class="form-check-label" for="debit">UPI/Net Banking</label>
          </div>
          <div class="form-check">
        ...
        <button class="w-100 bg-warning text-success fw-bolder btn-lg" type="submit">Continue to checkout</button>
      </form>
    </div>
  </div>
  </div>
